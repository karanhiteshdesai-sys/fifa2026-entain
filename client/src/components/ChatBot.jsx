        ...
        {isOpen ? (
          ...
          <svg viewBox="0 0 100 100" className="w-[4.5rem] h-[4.5rem]" aria-hidden="true">
            ...
            <g className="animate-bot-antenna" style={{ transformOrigin: '50px 30px' }}>
              <line x1="50" y1="25" x2="50" y2="15" stroke="#ffffff" strokeWidth="3" strokeLinecap="round" />
              <circle cx="50" cy="12" r="4" fill="#ffffff" className="animate-bot-glow" />
            </g>
            {/* Head */}
            <g className="animate-bot-head" style={{ transformOrigin: '50px 45px' }}>
              <rect x="25" y="25" width="50" height="40" rx="10" fill="#1a2744" stroke="#ffffff" strokeWidth="2" />
              {/* Eyes */}
              <circle cx="38" cy="42" r="5" fill="#ffffff" className="animate-bot-blink" />
              <circle cx="62" cy="42" r="5" fill="#ffffff" className="animate-bot-blink" />
              {/* Mouth */}
              <rect x="40" y="52" width="20" height="4" rx="2" fill="#ffffff" opacity="0.7" />
            </g>
            {/* Body */}
            <rect x="30" y="68" width="40" height="25" rx="8" fill="#1a2744" stroke="#ffffff" strokeWidth="2" />
            {/* Arms */}
            <rect x="18" y="72" width="10" height="4" rx="2" fill="#ffffff" opacity="0.6" className="animate-bot-wave" style={{ transformOrigin: '28px 74px' }} />
            <rect x="72" y="72" width="10" height="4" rx="2" fill="#ffffff" opacity="0.6" />
            {/* Chest light */}
            <circle cx="50" cy="80" r="4" fill="#ffffff" className="animate-bot-glow" />
          </svg>
        )}
      </button>
